...
export function calendario(){
   ...
   var calendar = new FullCalendar.Calendar(calendarEl, {
       ...
       eventMouseEnter: function(mouseEnterInfo){
           ...
           newEl.innerHTML=`
               <section id="evento_1" style="position: absolute; bottom :100%; width: 180px; height: auto; cursor:pointer; z-index:50; padding: 0.75rem; background-color: yellow; border: 2px solid #e2e8f0;">
