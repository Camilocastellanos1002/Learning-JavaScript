          ...
          grado.addEventListener("click", (e) => {
            ...
            subjects.forEach((subject) => {
              ...
              document.addEventListener("DOMContentLoaded", () => {
                ...
                // 3.funcion con el evento para reconocer el evento click
                    ...
                    tbody.innerHTML += `
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <button class="btn btn-outline-primary btn-editar" userId="${user.id}">Actualizar</button>
                                <button class="btn btn-outline-danger btn-delete"  userId="${user.id}">Eliminar</button>
        ...
        function show(estudiantes) {
          ...
          estudiantes.forEach((estudiante) => {
            ...
            estudianteHtml.innerHTML = `
                        ...
                        <div class="card">
                        <img src="/images/${imagen}"" class="card-media" width="170rem"/>
